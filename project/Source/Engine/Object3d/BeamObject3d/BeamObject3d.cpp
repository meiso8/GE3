...
void BeamObject3d::DrawCommand(Camera& camera)
{   
    ...
    if (primitive_) {
        primitive_->SetRootSignatureAndGraphicsPipeline(commandList_, blendMode_, cullMode_, maskMode_, true, RootSignature::BEAM, DxcCompiler::VS_Beam, DxcCompiler::PS_Beam);

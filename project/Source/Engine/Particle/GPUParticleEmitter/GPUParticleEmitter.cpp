...
void GPUParticleEmitter::Update()
{
    ...
    cbvSrvUavDescriptorHeap_->SetComputeRootDescriptorTable(3, particleGroup_->particleFreeListIndexResource.uavIndex, commandList_);
    cbvSrvUavDescriptorHeap_->SetComputeRootDescriptorTable(4, particleGroup_->particleFreeListResource.uavIndex, commandList_);
    ...
    cbvSrvUavDescriptorHeap_->SetComputeRootDescriptorTable(2, particleGroup_->particleFreeListIndexResource.uavIndex, commandList_);
    cbvSrvUavDescriptorHeap_->SetComputeRootDescriptorTable(3, particleGroup_->particleFreeListResource.uavIndex, commandList_);
